...
// Calcula, para un conjunto de calificaciones de TODO el año, la nota
// definitiva por asignatura (promedio de períodos, usando recuperación/
// habilitación cuando reemplazan la nota original) y el resultado final
// del año según la configuración de la institución.
const calcularConsolidadoAnio = (calificaciones, configuracion) => {
  ...
  // Promedio por área (útil para el resumen de la constancia con notas).
  const areasMap = new Map();
  filas.forEach((f) => {
  ...
  return { filas, resumenAreas, promedioGeneral, resultado };
};
